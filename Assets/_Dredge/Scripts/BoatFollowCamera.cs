...
namespace Dredge
{
    ...
    public class BoatFollowCamera : MonoBehaviour
    {
        ...
        [SerializeField] float pitch = 8f;    // FOV 45te ufuk karenin ~%32sinde (Dredge: ~%45, neredeyse düz bakış)
        [SerializeField] float pitchMin = 5f;
        [SerializeField] float pitchMax = 62f;
        [SerializeField] float zoomStep = 3f;
        [Tooltip("Zoom yumuşatma (1/sn). Büyük = daha hızlı oturur.")]
        ...
        /// <summary>Zoom anlık atlamaz; hedefe üstel yaklaşır. Yaklaşınca kamera hafifçe alçalır.</summary>
        void SmoothZoom()
        {
